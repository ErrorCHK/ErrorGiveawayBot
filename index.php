...
$botToken = "7068678212:AAFaAfZt1c9B_HycvC6PW5QtDxC_fL8oMZM";
...
if ($cdata2 == "back2") {
    $gatesText = "𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝘾𝙖𝙧𝙙𝙚𝙧𝙨 𝙃𝙚𝙧𝙚 𝙔𝙤𝙪 𝙒𝙞𝙡𝙡 𝙂𝙚𝙩 𝙈𝙖𝙣𝙮 𝙏𝙤𝙤𝙡𝙨 𝘼𝙣𝙙 𝙏𝙝𝙞𝙣𝙜𝙨 𝘼𝙗𝙤𝙪𝙩 𝘾𝙖𝙧𝙙𝙞𝙣𝙜...
...
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟎", 'callback_data' => 'mm'], ['text' => "𝟐 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'freec']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟏", 'callback_data' => 'free'], ['text' => "𝟑 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'freea']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟐", 'callback_data' => 'freec'], ['text' => "𝟒 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'freeg']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟑", 'callback_data' => 'freea'], ['text' => "𝟓 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'freeh']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
$premiumgButton = json_encode([
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟒", 'callback_data' => 'freeg'], ['text' => "𝟓 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'mm']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟎", 'callback_data' => 'premium'], ['text' => "𝟐 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'premiump']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
$freeButton = json_encode([
'inline_keyboard' => [
                                 [['text' => "⥫ 𝐁𝐚𝐜𝐤 𝐏𝐚𝐠𝐞 𝟐", 'callback_data' => 'premium'], ['text' => "𝟑 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞 ⥭", 'callback_data' => 'mm']],
                                 [['text' => '𝙷𝚘𝚖𝚎', 'callback_data' => 'gates']]
                             ]
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝐂𝐡𝐚𝐧𝐧𝐞𝐥", 'url' => "t.me/ERROR_EMPIRE"], ['text' => "𝐆𝐫𝐨𝐮𝐩", 'url' => "t.me/ERROR_EMPIRE"]],
        [['text' => "𝙱𝚊𝚌𝚔", 'callback_data' => 'back2']]
    ]
]);

if ($cdata2 == "channel") {
    $channelText = "𝙔𝙤𝙪 𝘾𝙖𝙣 𝙅𝙤𝙞𝙣 𝙈𝙮 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙃𝙚𝙧𝙚 𝙔𝙤𝙪 𝙒𝙞𝙡𝙡 𝙂𝙚𝙩 𝙉𝙚𝙬 𝙈𝙚𝙩𝙝𝙤𝙙𝙨 𝘼𝙣𝙙 𝙂𝙖𝙩𝙚𝙬𝙖𝙮𝙨 𝙐𝙥𝙙𝙖𝙩𝙚𝙨 𝘼𝙣𝙙 𝙈𝙤𝙧𝙚 𝙈𝙪𝙘𝙝.
    
𝙅𝙤𝙞𝙣 𝙈𝙮 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝘼𝙣𝙙 𝙂𝙚𝙩 𝘼𝙡𝙡 𝙐𝙥𝙙𝙖𝙩𝙚𝙨 𝘼𝙗𝙤𝙪𝙩 𝙈𝙚";
...
//==========back and close========//
if ($cdata2 == "back2") {
    $backtxt = ("𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝘾𝙖𝙧𝙙𝙚𝙧𝙨 𝙃𝙚𝙧𝙚 𝙔𝙤𝙪 𝙒𝙞𝙡𝙡 𝙂𝙚𝙩 𝙈𝙖𝙣𝙮 𝙏𝙤𝙤𝙡𝙨 𝘼𝙣𝙙 𝙏𝙝𝙞𝙣𝙜𝙨 𝘼𝙗𝙤𝙪𝙩 𝘾𝙖𝙧𝙙𝙞𝙣𝙜...
